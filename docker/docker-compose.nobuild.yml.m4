...
dnl
dnl Usage:
dnl   m4 docker-compose.nobuild.yml.m4 > docker-compose.yml
dnl   ( set -a; source .env; m4 docker-compose.nobuild.yml.m4 ) > docker-compose.yml
dnl
dnl ----------------------------------------
divert(-1)dnl
...
ifenvelse(`DEFAULT_DOCKER_REGISTRY', openslides-client):latest)
